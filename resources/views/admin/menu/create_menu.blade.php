...
<div class="main">
    <div class="header-left">
        ...
        <h1 style="margin: 0; font-size: 1.875rem; font-weight: 800; color: #0f172a; flex: 1; text-align: center; margin-right: 40px;">Add New Dish</h1>
    </div>
    <div class="card">
        ...
        <form action="/admin/menu/store" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem;">
                ...
                <div class="form-group" style="flex: 1; margin-bottom: 0;">
                    ...
                    <input type="number" step="0.01" name="discount_value" id="discount_value" value="{{ old('discount_value') }}" placeholder="0.00" {{ old('discount_type') ? '' : 'disabled' }}>
